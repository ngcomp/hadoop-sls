...
public class SLSRunner {
    ...
    public void start() throws Exception {
        ...
        //RAMP
        ((ResourceSchedulerWrapper) rm.getResourceScheduler()).setRm(this.rm);
    ...
    private void startAM() throws YarnException, IOException {
        ...
        int containerMemoryMB = conf.getInt(SLSConfiguration.CONTAINER_MEMORY_MB, SLSConfiguration.CONTAINER_MEMORY_MB_DEFAULT);
        int containerVCores = conf.getInt(SLSConfiguration.CONTAINER_VCORES, SLSConfiguration.CONTAINER_VCORES_DEFAULT);
    ...
    private void printSimulationInfo() {
        if (printSimulation) {
            ...
            LOG.info("------------------------------------");
            // queue
            LOG.info(MessageFormat.format("number of queues = {0}  average " + "number of apps = {1}", queueAppNumMap.size(),
